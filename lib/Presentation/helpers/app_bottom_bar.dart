...
//   const BottomNavBar({super.key, this.activeIcon = 0, this.isProfile = false});

//   void _onItemTapped(BuildContext context, int index) {
//     // final List<String> routes = [
//     //   RoutePaths.homeRoute,
//     //   RoutePaths.venueRoute,
//     //   RoutePaths.donateRoute,
//     //   RoutePaths.missionRoute,
//     // ];
...
//           BottomNavigationBarItem(
//             icon: Image.asset(
//               isProfile && activeIcon == 0 ? ImageAssets.activeImpactIcon : ImageAssets.notActiveImpactIcon,
//               width: 32,
//               height: 32,
//             ),
//             label: 'Impact',
...
//           BottomNavigationBarItem(
//             icon: Image.asset(
//               isProfile && activeIcon == 1 ? ImageAssets.activeLocationIcon : ImageAssets.notActiveLocationIcon,
//               width: 32,
//               height: 32,
//             ),
//             label: 'Venues',
...
//           BottomNavigationBarItem(
//             icon: Image.asset(
//               isProfile && activeIcon == 2 ? ImageAssets.activeDonateIcon : ImageAssets.notActiveDonateIcon,
//               width: 32,
//               height: 32,
//             ),
//             label: 'Donate',
...
//           BottomNavigationBarItem(
//             icon: Image.asset(
//               isProfile && activeIcon == 3 ? ImageAssets.activeMissionIcon : ImageAssets.notActiveMissionIcon,
//               width: 32,
//               height: 32,
//             ),
//             label: 'Mission',
